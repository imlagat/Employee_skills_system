      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 24px' }}>
        <div className="login-card" style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <h2 style={{ color: '#0f172a', fontSize: '1.75rem', fontWeight: 800, margin: '0 0 8px 0' }}>Join SkillMatrix</h2>
            <p style={{ color: '#475569', margin: 0, fontSize: '0.95rem' }}>Sign in to access your talent dashboard</p>
          </div>

          {error && <div className="login-error" style={{ background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca', borderRadius: '8px', padding: '12px', fontSize: '0.9rem', marginBottom: '24px', textAlign: 'center' }}>{error}</div>}

          <form className="landing-contact-form" onSubmit={handleSubmit}>
            <div className="form-group" style={{ marginBottom: '20px' }}>
              <label htmlFor="login-username" style={{ display: 'block', fontSize: '0.85rem', color: '#475569', marginBottom: '8px', fontWeight: '600' }}>Username or Email</label>
              <input 
                type="text" 
                id="login-username"
                value={username}
            ...
            <div className="form-group" style={{ marginBottom: '20px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                <label htmlFor="login-password" style={{ fontSize: '0.85rem', color: '#475569', fontWeight: '600' }}>Password</label>
            ...
            <div style={{ display: 'flex', alignItems: 'center', margin: '20px 0', color: '#94a3b8', fontSize: '0.8rem' }}>
            ...
            <button 
              ...
              disabled={isLoading}
              style={{ padding: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', color: '#0f172a', borderColor: '#cbd5e1', background: '#ffffff' }}
            >
